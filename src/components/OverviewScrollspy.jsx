      ...
      <MDBRow>
        <MDBCol md='3'>
          <MDBScrollspy container={containerRef}>
            <MDBScrollspyLink targetRef={section1}>About Me</MDBScrollspyLink>
            <MDBScrollspyLink targetRef={section2}>Experience</MDBScrollspyLink>
            {/* collapse subsection */}
            <MDBScrollspyLink subsections={subsections} targetRef={section3} collapsible>
              Education
            </MDBScrollspyLink>
            {/* collapse subsection */}
            <MDBScrollspySubList className='ps-3' collapsible={subsections}>
